      ...
      <section className="lg:pt-[180px] lg:pb-24 pb-16 pt-[150px]">
        ...
        <div className="grid grid-cols-12 gap-5">
          {portfolio.map(({ id, src, href, scrollerTitle }) => (
            <div key={id} className="md:col-span-6 col-span-12 relative overflow-hidden group">
              <Link href={href}>
                <Image
                  className="w-full"
                  width={800}
                  ...
                  alt="portfolio image"
                />
                <span className="absolute inset-x-0 top-0 bottom-0 transition-colors duration-500" />
